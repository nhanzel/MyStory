<template>
  <div>
    <img :src="imageSource" alt="Lds Logo" width="550vw" height="550vh"></img>
  </div>
  <div>
    ...
    <p> - I can't think of a better example of <span class="bolded">eustress</span> in my life than my deconstruction. I
      ...
      with respect.</p>
    <p> - I don't have anything negative against Mormons, most of my family and friends are still in the faith, but I'm
      glad to have my new sense of empathy and acceptance with the life we're given.</p>
  </div>
</template>

<script>
import ldsLogoImage from '../assets/lds_logo.jpg';

export default {
  name: 'Deconstruction',
  data() {
    return {
      imageSource: ldsLogoImage,
    };
  },
  methods: {
  },
